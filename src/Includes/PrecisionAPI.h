...
namespace PRECISION_API {
    ...
    struct PreHitModifier {
        enum class ModifierType : uint8_t { Damage, Stagger };

        enum class ModifierOperation : uint8_t { Additive, Multiplicative };
    ...
    struct PreHitCallbackReturn {
        // if set to true, the hit will be ignored, no matter what. Do this if you need the game to ignore a hit that
        // would otherwise happen (e.g. a parry)
    ...
    struct WeaponCollisionCallbackReturn {
        // if set to true, the hit to the weapon owner will be ignored. Otherwise the game will handle the hit normally
        // as if the weapon was the actor's body.
    ...
    struct PrecisionHitData {
        PrecisionHitData(RE::Actor* a_attacker, RE::TESObjectREFR* a_target, RE::hkpRigidBody* a_hitRigidBody,
                         RE::hkpRigidBody* a_hittingRigidBody, const RE::NiPoint3& a_hitPos,
                         const RE::NiPoint3& a_separatingNormal, const RE::NiPoint3& a_hitPointVelocity,
                         RE::hkpShapeKey a_hitBodyShapeKey, RE::hkpShapeKey a_hittingBodyShapeKey)
            : attacker(a_attacker),
              target(a_target),
    ...
    enum class RequestedAttackCollisionType : uint8_t {
        Default,  // Return the largest currently active collision length, otherwise calculate right weapon's collision
                  // length
    ...
    public:
        ...
        virtual APIResult AddPreHitCallback(SKSE::PluginHandle a_myPluginHandle,
        ...
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddPostHitCallback(SKSE::PluginHandle a_myPluginHandle,
        ...
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddPrePhysicsStepCallback(SKSE::PluginHandle a_myPluginHandle,
                                                    PrePhysicsStepCallback&& a_prePhysicsStepCallback) noexcept = 0;

        /// <summary>
        /// Adds a callback that will run when havok compares collision filter info to determine if two objects should
        /// collide. This can be called hundreds of times per frame, so be brief.
        /// </summary>
        /// <param name="a_myPluginHandle">Your assigned plugin handle</param>
        ...
        /// <summary>
        /// Removes the callback that will run when havok compares collision filter info to determine if two objects
        /// should collide.
        /// </summary>
        /// <param name="a_myPluginHandle">Your assigned plugin handle</param>
        /// <returns>OK, NotRegistered</returns>
        ...
        /// <summary>
        /// Gets the current attack collision capsule length. In case of multiple active collisions, returns the
        /// largest. If there's no active collision, tries the best guess. Can be a bit complex so try not to call it
        /// every frame.
        /// </summary>
        ...
        virtual float GetAttackCollisionCapsuleLength(
            ...
            RequestedAttackCollisionType a_collisionType = RequestedAttackCollisionType::Default) const noexcept = 0;
    };
    ...
    public:
        ...
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddWeaponWeaponCollisionCallback(SKSE::PluginHandle a_myPluginHandle,
        ...
        /// <param name="a_callback">The callback function</param>
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddWeaponProjectileCollisionCallback(SKSE::PluginHandle a_myPluginHandle,
                                                               WeaponCollisionCallback&& a_callback) noexcept = 0;
        ...
        [[deprecated("Use ApplyHitImpulse2 instead")]] virtual void ApplyHitImpulse(RE::ActorHandle a_actorHandle,
    ...
    public:
        ...
        /// <param name="a_callback">The callback function</param>
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddCollisionFilterSetupCallback(SKSE::PluginHandle a_myPluginHandle,
        ...
        /// <param name="a_callback">The callback function</param>
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddContactListenerCallback(SKSE::PluginHandle a_myPluginHandle,
        ...
        /// <summary>
        /// Checks if the actor's character controller is considered hittable by Precision (the actor is either not
        /// "active", or their ragdoll has no collision - e.g. wisps)
        /// </summary>
        /// <param name="a_actorHandle">Actor handle</param>
        ...
        /// <summary>
        /// Checks if the character controller is considered hittable by Precision (the actor is either not "active", or
        /// their ragdoll has no collision - e.g. wisps)
        /// </summary>
    ...
    public:
        ...
        /// <param name="a_callback">The callback function</param>
        /// <returns>OK, AlreadyRegistered</returns>
        virtual APIResult AddPrecisionLayerSetupCallback(SKSE::PluginHandle a_myPluginHandle,
        ...
        virtual RE::NiAVObject* GetOriginalFromClone(RE::ActorHandle a_actorHandle,
        ...
        virtual RE::hkpRigidBody* GetOriginalFromClone(RE::ActorHandle a_actorHandle,
        ...
        virtual void ApplyHitImpulse2(RE::ActorHandle a_targetActorHandle, RE::ActorHandle a_sourceActorHandle,
                                      RE::hkpRigidBody* a_rigidBody, const RE::NiPoint3& a_hitVelocity,
                                      const RE::hkVector4& a_hitPosition, float a_impulseMult) noexcept = 0;
    };
    ...
    /// SKSEMessagingInterface::kMessage_PostLoad seems to be unreliable for some users for unknown reasons.
    /// </summary>
    ...
    [[nodiscard]] inline void* RequestPluginAPI(const InterfaceVersion a_interfaceVersion = InterfaceVersion::V4) {
        auto pluginHandle = REX::W32::GetModuleHandleW(L"Precision.dll");
